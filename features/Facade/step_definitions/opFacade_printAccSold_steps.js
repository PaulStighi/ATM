...
When('OpFacade : The operator facade tries to printAccSold', function () {
    if(operator.op_facade.printAccSold(operator.authenticator.getAccSold()).ret)
...
Then('OpFacade : The answer of printAccSold should be {string}', function (string) {
